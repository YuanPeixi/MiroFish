...
# 本体生成的系统提示词
ONTOLOGY_SYSTEM_PROMPT = """你是一个专业的知识图谱本体设计专家。你的任务是分析给定的文本内容和模拟需求，设计适合**剧情叙事模拟**的实体类型和关系类型。
...
- 每个实体都是一个可参与叙事关系、互动、传播信息的"角色"或"主体"
- 实体之间会相互影响、转发、评论、回应
    ...
    "entity_types": [
        {
            ...
            - 每个实体都是一个可以参与叙事、互动、推动情节的"角色"或"主体"
            - 实体之间会相互影响、回应、协作或对立
            - 我们需要模拟剧情事件中各方的反应和因果路径
        {
